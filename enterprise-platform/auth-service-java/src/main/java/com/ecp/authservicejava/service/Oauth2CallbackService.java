...
public class Oauth2CallbackService {
    ...
    private static final Logger log = LoggerFactory.getLogger(Oauth2CallbackService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing oauth2_callback", traceId);
        ...
        try {
            ...
            log.error("[{}] oauth2_callback failed: {}", traceId, e.getMessage());
