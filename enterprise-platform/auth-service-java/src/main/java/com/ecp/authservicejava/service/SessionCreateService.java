...
public class SessionCreateService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SessionCreateService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing session_create", traceId);
        ...
        try {
            ...
            log.error("[{}] session_create failed: {}", traceId, e.getMessage());
