...
public class JwtTokenVerifyService {
    ...
    private static final Logger log = LoggerFactory.getLogger(JwtTokenVerifyService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing jwt_token_verify", traceId);
        ...
        try {
            ...
            log.error("[{}] jwt_token_verify failed: {}", traceId, e.getMessage());
