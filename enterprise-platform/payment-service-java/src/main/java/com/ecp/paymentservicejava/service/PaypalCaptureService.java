...
public class PaypalCaptureService {
    ...
    private static final Logger log = LoggerFactory.getLogger(PaypalCaptureService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing paypal_capture", traceId);
        ...
        try {
            ...
            log.error("[{}] paypal_capture failed: {}", traceId, e.getMessage());
