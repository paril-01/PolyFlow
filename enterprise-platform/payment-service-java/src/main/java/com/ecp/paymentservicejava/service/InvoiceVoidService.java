...
public class InvoiceVoidService {
    ...
    private static final Logger log = LoggerFactory.getLogger(InvoiceVoidService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing invoice_void", traceId);
        ...
        try {
            ...
            log.error("[{}] invoice_void failed: {}", traceId, e.getMessage());
