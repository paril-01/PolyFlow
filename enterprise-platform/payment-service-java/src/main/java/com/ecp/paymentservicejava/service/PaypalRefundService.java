...
public class PaypalRefundService {
    ...
    private static final Logger log = LoggerFactory.getLogger(PaypalRefundService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing paypal_refund", traceId);
        ...
        try {
            ...
            log.error("[{}] paypal_refund failed: {}", traceId, e.getMessage());
