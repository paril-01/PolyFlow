...
@Service
public class RefundFullService {

    private static final Logger log = LoggerFactory.getLogger(RefundFullService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing refund_full", traceId);
        ...
        try {
            ...
            log.error("[{}] refund_full failed: {}", traceId, e.getMessage());
