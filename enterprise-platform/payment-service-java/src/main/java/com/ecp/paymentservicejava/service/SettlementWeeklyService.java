...
public class SettlementWeeklyService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SettlementWeeklyService.class);

    public Map<String, Object> execute(Map<String, Object> request) {
        long start = System.currentTimeMillis();
        String traceId = UUID.randomUUID().toString().substring(0, 8);
        log.info("[{}] Executing settlement_weekly", traceId);
        ...
        try {
            ...
            log.error("[{}] settlement_weekly failed: {}", traceId, e.getMessage());
