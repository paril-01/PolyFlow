"""Tests for Image Classify."""
import pytest
from app.services.image_classify import ImageClassifyService


class TestImageClassifyService:
    """Test suite for ImageClassifyService."""

    def setup_method(self):
        self.service = ImageClassifyService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "image_classify"
