"""Tests for Text Language Detect."""
import pytest
from app.services.text_language_detect import TextLanguageDetectService


class TestTextLanguageDetectService:
    """Test suite for TextLanguageDetectService."""

    def setup_method(self):
        self.service = TextLanguageDetectService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "text_language_detect"
