"""Tests for Review Sentiment Analyze."""
import pytest
from app.services.review_sentiment_analyze import ReviewSentimentAnalyzeService


class TestReviewSentimentAnalyzeService:
    """Test suite for ReviewSentimentAnalyzeService."""

    def setup_method(self):
        self.service = ReviewSentimentAnalyzeService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "review_sentiment_analyze"
