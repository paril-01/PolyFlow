"""Tests for Review Summarize."""
import pytest
from app.services.review_summarize import ReviewSummarizeService


class TestReviewSummarizeService:
    """Test suite for ReviewSummarizeService."""

    def setup_method(self):
        self.service = ReviewSummarizeService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "review_summarize"
