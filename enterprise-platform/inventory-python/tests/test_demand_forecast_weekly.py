"""Tests for Demand Forecast Weekly."""
import pytest
from app.services.demand_forecast_weekly import DemandForecastWeeklyService


class TestDemandForecastWeeklyService:
    """Test suite for DemandForecastWeeklyService."""

    def setup_method(self):
        self.service = DemandForecastWeeklyService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "demand_forecast_weekly"
