"""Tests for Supplier Create."""
import pytest
from app.services.supplier_create import SupplierCreateService


class TestSupplierCreateService:
    """Test suite for SupplierCreateService."""

    def setup_method(self):
        self.service = SupplierCreateService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "supplier_create"
