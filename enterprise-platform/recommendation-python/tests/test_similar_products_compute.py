"""Tests for Similar Products Compute."""
import pytest
from app.services.similar_products_compute import SimilarProductsComputeService


class TestSimilarProductsComputeService:
    """Test suite for SimilarProductsComputeService."""

    def setup_method(self):
        self.service = SimilarProductsComputeService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "similar_products_compute"
