"""Tests for Recently Viewed Record."""
import pytest
from app.services.recently_viewed_record import RecentlyViewedRecordService


class TestRecentlyViewedRecordService:
    """Test suite for RecentlyViewedRecordService."""

    def setup_method(self):
        self.service = RecentlyViewedRecordService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "recently_viewed_record"
