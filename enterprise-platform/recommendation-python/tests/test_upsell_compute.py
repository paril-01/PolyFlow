"""Tests for Upsell Compute."""
import pytest
from app.services.upsell_compute import UpsellComputeService


class TestUpsellComputeService:
    """Test suite for UpsellComputeService."""

    def setup_method(self):
        self.service = UpsellComputeService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "upsell_compute"
