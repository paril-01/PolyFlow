"""Tests for Trending Compute Daily."""
import pytest
from app.services.trending_compute_daily import TrendingComputeDailyService


class TestTrendingComputeDailyService:
    """Test suite for TrendingComputeDailyService."""

    def setup_method(self):
        self.service = TrendingComputeDailyService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "trending_compute_daily"
