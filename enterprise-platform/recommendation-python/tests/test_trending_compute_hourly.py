"""Tests for Trending Compute Hourly."""
import pytest
from app.services.trending_compute_hourly import TrendingComputeHourlyService


class TestTrendingComputeHourlyService:
    """Test suite for TrendingComputeHourlyService."""

    def setup_method(self):
        self.service = TrendingComputeHourlyService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "trending_compute_hourly"
