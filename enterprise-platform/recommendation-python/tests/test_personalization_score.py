"""Tests for Personalization Score."""
import pytest
from app.services.personalization_score import PersonalizationScoreService


class TestPersonalizationScoreService:
    """Test suite for PersonalizationScoreService."""

    def setup_method(self):
        self.service = PersonalizationScoreService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "personalization_score"
