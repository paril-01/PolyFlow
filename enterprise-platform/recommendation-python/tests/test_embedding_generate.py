"""Tests for Embedding Generate."""
import pytest
from app.services.embedding_generate import EmbeddingGenerateService


class TestEmbeddingGenerateService:
    """Test suite for EmbeddingGenerateService."""

    def setup_method(self):
        self.service = EmbeddingGenerateService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "embedding_generate"
