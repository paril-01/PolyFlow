"""Tests for Embedding Index Build."""
import pytest
from app.services.embedding_index_build import EmbeddingIndexBuildService


class TestEmbeddingIndexBuildService:
    """Test suite for EmbeddingIndexBuildService."""

    def setup_method(self):
        self.service = EmbeddingIndexBuildService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "embedding_index_build"
