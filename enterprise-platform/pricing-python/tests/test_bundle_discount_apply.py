"""Tests for Bundle Discount Apply."""
import pytest
from app.services.bundle_discount_apply import BundleDiscountApplyService


class TestBundleDiscountApplyService:
    """Test suite for BundleDiscountApplyService."""

    def setup_method(self):
        self.service = BundleDiscountApplyService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "bundle_discount_apply"
