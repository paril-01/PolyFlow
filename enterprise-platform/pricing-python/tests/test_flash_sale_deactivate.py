"""Tests for Flash Sale Deactivate."""
import pytest
from app.services.flash_sale_deactivate import FlashSaleDeactivateService


class TestFlashSaleDeactivateService:
    """Test suite for FlashSaleDeactivateService."""

    def setup_method(self):
        self.service = FlashSaleDeactivateService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "flash_sale_deactivate"
