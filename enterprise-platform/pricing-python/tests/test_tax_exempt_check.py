"""Tests for Tax Exempt Check."""
import pytest
from app.services.tax_exempt_check import TaxExemptCheckService


class TestTaxExemptCheckService:
    """Test suite for TaxExemptCheckService."""

    def setup_method(self):
        self.service = TaxExemptCheckService()
    ...
    def test_process_returns_domain(self):
        ...
        assert result["feature"] == "tax_exempt_check"
