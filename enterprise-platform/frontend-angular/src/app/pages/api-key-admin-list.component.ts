...
@Component({
  selector: 'app-api-key-admin-list',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">Api Key Admin List</h3>
...
export class ApiKeyAdminListComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/api-key-admin-list', {}).subscribe({
