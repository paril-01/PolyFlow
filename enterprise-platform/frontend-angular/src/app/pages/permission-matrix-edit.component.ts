...
@Component({
  selector: 'app-permission-matrix-edit',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">Permission Matrix Edit</h3>
...
export class PermissionMatrixEditComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/permission-matrix-edit', {}).subscribe({
