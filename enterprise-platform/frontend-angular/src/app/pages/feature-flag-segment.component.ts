...
@Component({
  selector: 'app-feature-flag-segment',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">Feature Flag Segment</h3>
...
export class FeatureFlagSegmentComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/feature-flag-segment', {}).subscribe({
