...
@Component({
  selector: 'app-feature-flag-create',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">Feature Flag Create</h3>
...
export class FeatureFlagCreateComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/feature-flag-create', {}).subscribe({
