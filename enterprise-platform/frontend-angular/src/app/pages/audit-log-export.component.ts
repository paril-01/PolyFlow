...
@Component({
  selector: 'app-audit-log-export',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">Audit Log Export</h3>
...
export class AuditLogExportComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/audit-log-export', {}).subscribe({
