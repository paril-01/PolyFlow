...
@Component({
  selector: 'app-permission-matrix-view',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">Permission Matrix View</h3>
...
export class PermissionMatrixViewComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/permission-matrix-view', {}).subscribe({
