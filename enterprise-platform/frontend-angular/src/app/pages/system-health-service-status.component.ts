...
@Component({
  selector: 'app-system-health-service-status',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">System Health Service Status</h3>
...
export class SystemHealthServiceStatusComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/system-health-service-status', {}).subscribe({
