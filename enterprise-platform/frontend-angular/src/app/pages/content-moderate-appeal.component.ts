...
@Component({
  selector: 'app-content-moderate-appeal',
  template: `
    <div class="p-4 bg-white rounded shadow-sm border">
      <h3 class="text-lg font-semibold">Content Moderate Appeal</h3>
...
export class ContentModerateAppealComponent {
  loading = false;
  result: any = null;
  ...
  execute() {
    this.loading = true;
    this.error = null;
    this.http.post('/api/v1/admin/content-moderate-appeal', {}).subscribe({
